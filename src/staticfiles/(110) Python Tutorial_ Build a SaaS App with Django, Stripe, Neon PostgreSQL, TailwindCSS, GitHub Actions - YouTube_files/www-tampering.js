...
;!L("Android")||N();N();L("Safari")&&(N()||(M()?0:L("Coast"))||(M()?0:L("Opera"))||(M()?0:L("Edge"))||(M()?K("Microsoft Edge"):L("Edg/"))||M()&&K("Opera"));Math.max.apply(Math,x(Object.values({A:1,u:2,s:4,D:8,C:16,B:32,i:64,G:128,o:256,m:512,v:1024,j:2048,F:4096,l:8192})));function O(){}
Object.freeze(new function(){});
Object.freeze(new O);Object.freeze(new O);var P=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function Q(a){return a?decodeURI(a):a}
;var R=A.window,S,T,U=(R==null?void 0:(S=R.yt)==null?void 0:S.config_)||(R==null?void 0:(T=R.ytcfg)==null?void 0:T.data_)||{};B("yt.config_",U);var V=Object.freeze("document.appendChild document.body.appendChild document.querySelector document.querySelectorAll history.back history.go".split(" ")),W=Object.freeze("fonts.googleapis.com s0.2mdn.net securepubads.g.doubleclick.net ssl.google-analytics.com static.doubleclick.net www.google-analytics.com www.googletagservices.com www.youtube.com youtube.com".split(" ")),X=Object.freeze(["pkedcjkdefgpdelpbcmbmeomcjbeemfm","fjhoaacokmgbjemoflkofnenfaiekifl","enhhojjnijigcajfphajepfemndkmdlo"]),aa=
Object.freeze(".corp.google.com .googlevideo.com .ytimg.com .google.com .googlesyndication.com .gstatic.com .prod.google.com .google.ru".split(" ")),ba=Object.freeze(["chrome-extension","safari-extension","safari-resource","opera"]);function ca(){return V.map(function(a){return da(a)}).filter(function(a){return!!a})}
function da(a){var b=a.split(".");a=b[b.length-1];b=b.reduce(function(c,e){return c&&c[e]},window);
...
function Y(a){var b=a.match(P)[1]||null;return ba.some(function(c){return b==c})}
function Z(a){var b=Q(a.match(P)[3]||null);return!b||Y(a)?!0:W.some(function(c){return b==c})||aa.some(function(c){return b.endsWith(c)})}
function ea(a){if(!Y(a))return null;var b=Q(a.match(P)[3]||null);return b?X.some(function(c){return b==c})?null:b:null}
function fa(){var a=new Set;[].concat(x(document.querySelectorAll("script"))).forEach(function(b){b.src&&!Z(b.src)&&a.add(b.src)});
...
function ha(){var a=new Set;[].concat(x(document.querySelectorAll("script"))).forEach(function(b){b.src&&(b=ea(b.src))&&a.add(b)});
return[].concat(x(a)).sort()}
;B("ytbin.polymer.shared.lib.tampering.info",function(){var a=fa(),b=ca(),c=ha(),e=[];c.length&&e.push("extensions",c);a.length&&e.push("suspiciousIncludes",a);b.length&&e.push("suspiciousApis",b);return e.length?e:null});}).call(this);
